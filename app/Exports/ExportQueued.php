...
/**
 * Queued export: bindValue() not working when ShouldQueue is used
 * Class ExportQueued
 * @package App\Exports
 */
class ExportQueued extends DefaultValueBinder implements FromQuery, WithCustomCsvSettings, WithCustomValueBinder, WithStrictNullComparison, ShouldQueue
{
	use Exportable;
